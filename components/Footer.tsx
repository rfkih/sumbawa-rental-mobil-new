...
const footerLinks = [
  {
    title: "Contact",
    links: [
      { title: "Email: sumbawarentalmobil@gmail.com", url: "mailto:sumbawarentalmobil@gmail.com" },
      { title: "Phone: +62 813-9008-5730", url: "https://wa.me/${whatsapp}?text=Halo%20Sewa%20Mobil%20Sekongkang,%20saya%20ingin%20memesan%20mobil." },
    ],
  },
];
          ...
          <div className="flex flex-col md:flex-row w-full gap-8">
            ...
            <div className="flex-1 min-w-[250px]">
              <div className="w-full h-[200px] md:h-[180px] rounded-xl overflow-hidden shadow-md border border-gray-200">
                <iframe
                  title="Lokasi CarHub Sekongkang Bawah"
